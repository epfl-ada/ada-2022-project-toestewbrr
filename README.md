...
To answer this question, we will first gather as much information as possible about each character involved in a love relationship. As a first step, we obtained the main role of each lover from the KBP tag `per:title`. The figure below shows the 10 most common roles among 955 romantic comedies.
